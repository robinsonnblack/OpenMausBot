...
const SKIN_CHROME = Object.freeze({
  ...
  "cyan-gpt": Object.freeze({ color: "#ffffff", symbolColor: "#62676e" }),
  chatgpt: Object.freeze({ color: "#ffffff", symbolColor: "#666666" }),
  custom: Object.freeze({ color: "#ffffff", symbolColor: "#666666" }),
});
