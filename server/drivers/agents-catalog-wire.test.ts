...
const BUDGET_BASELINE: Record<string, number> = {
  "direct": 41_761,
  "direct+shared": 43_506,
  "direct+skills": 43_687,
  "direct+skills+shared": 45_432,
  "room": 39_779,
  "room+shared": 41_524,
  "room+skills": 41_705,
  "room+skills+shared": 43_450,
  "room+own-thread": 41_066,
  "room+own-thread+shared": 42_811,
  "room+own-thread+skills": 42_992,
  "room+own-thread+skills+shared": 44_737,
  "external": 3_030,
